...
export const fr: CeodigitalMessages = {
  ...
  workspaces: {
    title: 'Espaces de travail CEODigital',
    openCommand: 'CEODigital : Ouvrir les espaces de travail',
    empty: 'Aucun espace de travail trouvé pour votre tenant.',
    new: 'Nouvel espace de travail',
    search: 'Rechercher des espaces de travail…',
    archivedOnly: 'Archivés uniquement',
    all: 'Tous',
    back: 'Retour aux espaces de travail',
    detail: 'Détail de l’espace de travail',
    members: 'Membres',
    membersEmpty: 'Aucun membre dans cet espace de travail.',
    role: 'Rôle',
    allRoles: 'Tous les rôles',
    memberRoles: { lead: 'Responsable', member: 'Membre', viewer: 'Lecteur' },
    addMember: 'Ajouter un membre',
    addMemberPlaceholder: 'Ajouter un membre par id d’utilisateur…',
    ...
    headers: { id: 'ID', title: 'Titre', description: 'Description', members: 'Membres' },
    memberHeaders: { id: 'ID', name: 'Nom', role: 'Rôle' },
    errors: {
      list: 'Impossible de charger les espaces de travail.',
      create: 'Impossible de créer l’espace de travail.',
      addMember: 'Impossible d’ajouter le membre.',
      removeMember: 'Impossible de retirer le membre.',
      fetchMembers: 'Impossible de charger les membres.',
      general: 'L’action a échoué. Réessayez.'
    }
  },
  departments: {
    title: 'Départements CEODigital',
    openCommand: 'CEODigital : Ouvrir les départements',
    empty: 'Aucun département trouvé pour votre tenant.',
    new: 'Nouveau département',
    search: 'Rechercher des départements…',
    activeOnly: 'Actifs uniquement',
    all: 'Tous',
    back: 'Retour aux départements',
    detail: 'Détail du département',
    members: 'Membres',
    membersEmpty: 'Aucun membre dans ce département.',
    role: 'Rôle',
    allRoles: 'Tous les rôles',
    memberRoles: { head: 'Chef', member: 'Membre' },
    addMember: 'Ajouter un membre',
    addMemberPlaceholder: 'Ajouter un membre par id d’utilisateur…',
    removeMember: 'Retirer',
    adding: 'Ajout…',
    ...
    createForm: {
      ...
      slugKey: 'Clé de slug',
      slugKeyPlaceholder: 'ex. : ingénierie',
      areas: 'Domaines (séparés par des virgules)',
      areasPlaceholder: 'Design, Backend, …',
      headId: 'Chef (id d’utilisateur)',
      headIdPlaceholder: 'Id d’utilisateur du chef du département',
      create: 'Créer le département',
      cancel: 'Annuler'
    },
    headers: { id: 'ID', title: 'Titre', slug: 'Slug', areas: 'Domaines', active: 'Actif' },
    memberHeaders: { id: 'ID', name: 'Nom', role: 'Rôle' },
    actions: { remove: 'Retirer' },
    errors: {
      list: 'Impossible de charger les départements.',
      create: 'Impossible de créer le département.',
      addMember: 'Impossible d’ajouter le membre.',
      removeMember: 'Impossible de retirer le membre.',
      fetchMembers: 'Impossible de charger les membres.',
      general: 'L’action a échoué. Réessayez.'
  ...
  members: {
    title: 'Membres CEODigital',
    openCommand: 'CEODigital : Ouvrir les membres',
    empty: 'Aucun membre trouvé pour votre tenant.',
    ...
    headers: { id: 'ID', name: 'Nom', email: 'Email', role: 'Rôle' },
    errors: {
      list: 'Impossible de charger les membres.',
      invite: 'Impossible d’inviter le membre.',
      revoke: 'Impossible de révoquer le membre.',
      updateRole: 'Impossible de mettre à jour le rôle.',
      general: 'L’action a échoué. Réessayez.'
    }
  },
  integrations: {
    title: 'Intégrations CEODigital',
    openCommand: 'CEODigital : Ouvrir les intégrations',
    empty: 'Aucune intégration connectée pour le moment.',
    connect: 'Connecter une intégration',
    ...
    status: 'Statut',
    scope: 'Périmètre',
    scopes: { user: 'Utilisateur', tenant: 'Tenant' },
    statuses: { pending: 'En attente', active: 'Actif', error: 'Erreur', revoked: 'Révoqué' },
    connectForm: {
      providerCode: 'Code du fournisseur',
      providerCodePlaceholder: 'ex. : gmail',
      appSlug: 'Slug de l’application',
      appSlugPlaceholder: 'ex. : gmail',
      scope: 'Périmètre',
      mailboxKey: 'Clé de mailbox',
      mailboxKeyPlaceholder: 'ex. : default',
      mailboxLabel: 'Libellé du mailbox',
      mailboxLabelPlaceholder: 'Nom affiché pour cette boîte',
      connect: 'Connecter',
      cancel: 'Annuler'
    },
    test: 'Tester',
    ...
    detail: 'Détail de l’intégration',
    back: 'Retour aux intégrations',
    headers: { id: 'ID', provider: 'Fournisseur', app: 'Application', status: 'Statut', scope: 'Périmètre', mailbox: 'Mailbox' },
    errors: {
      list: 'Impossible de charger les intégrations.',
      connect: 'Impossible de connecter l’intégration.',
      test: 'Impossible de tester l’intégration.',
      disconnect: 'Impossible de déconnecter l’intégration.',
      fetchIntegration: 'Impossible de charger cette intégration.',
      general: 'L’action a échoué. Réessayez.'
    }
  },
  errors: {
