---
name:
  pt-PT: "Diagnóstico e Reparação de Incidentes de Automação"
  en: "Automation Incident Triage & Auto-Fix"
description:
  pt-PT: "Analisa payloads JSON com erro no n8n/Webhooks, diagnostica a causa raiz (schema, auth, rate limit) e prepara o reenvio corrigido."
  en: "Inspects failed webhook payloads, diagnoses root cause (schema mismatch, expired token, rate limits), and suggests corrected replay payloads."
mode: agentic
visibility: tenant
needs_approval: false
required_capabilities: ["integrations.read", "chat.conversation.write"]
origin: catalog
version: "1.0.0"
---
